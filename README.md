...
- [Сравнение сервисов нагрузочного тестирования сайта](https://www.youtube.com/watch?v=qTqUXPsvnDI)
- [Методология тестирования: снэпшот-тесты компонент React](https://www.youtube.com/watch?v=9XTKCJ6CKbo)
<!-- YOUTUBE:END -->
